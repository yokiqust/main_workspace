...
public class PageProcess {
	@Autowired
	@Qualifier("CreateSpider")
	private CreateSpider cspider;
	...
	public void singleTopicUrlProcess(Page page) {
		...
		for (Selectable select : question_link) {
			...
			if (answer_count >= cspider.getAnswer_condition()) {
